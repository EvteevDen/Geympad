...
// Geympad.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGeympadApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CGeympadApp

CGeympadApp::CGeympadApp()
{
...
// Единственный объект CGeympadApp

CGeympadApp theApp;

// Инициализация CGeympadApp

BOOL CGeympadApp::InitInstance()
{
